...
def main():
    ...
    download("http://storage.iblocklist.com/t5j1mwxwpmwt6ihp4iau/files/xagxl7gslii0flcdhwcr/qlprgwgdkojunfdlzsiv.gz", "temp/iblocklist-hosts.gz")
    download("http://storage.iblocklist.com/t5j1mwxwpmwt6ihp4iau/files/94fn3mx9x0ikh1pisl10/xshktygkujudfnjfioro.gz", "temp/microsoft-p2p.gz")
    download("http://storage.iblocklist.com/t5j1mwxwpmwt6ihp4iau/files/qlw75gl94fcbr92o28do/xshktygkujudfnjfioro.gz", "temp/microsoft-cidr.gz")
    download("http://storage.iblocklist.com/t5j1mwxwpmwt6ihp4iau/files/tros60df0d6d8nqf7rwc/xoebmbyexwuiogmbyprb.gz", "temp/proxy-p2p.gz")
    download("http://storage.iblocklist.com/t5j1mwxwpmwt6ihp4iau/files/pnn41ppertncm9c0tmmv/xoebmbyexwuiogmbyprb.gz", "temp/proxy-cidr.gz")
