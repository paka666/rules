...
init_url_configs() {
  ...
  ads_urls=(
    "${SOURCE_DIR}/ads.json"
    "${SUBSET_DIR}/tmp/geosite-clearbitjs-ads.json"
    "${SUBSET_DIR}/tmp/geosite-clearbitjs-ads@ads.json"
    "${SUBSET_DIR}/tmp/geosite-leanplum-ads.json"
    "${SUBSET_DIR}/tmp/geosite-leanplum-ads@ads.json"
    "${SUBSET_DIR}/tmp/geosite-mixpanel-ads.json"
    "${SUBSET_DIR}/tmp/geosite-mixpanel-ads@ads.json"
    "${SUBSET_DIR}/tmp/geosite-onesignal-ads.json"
    "${SUBSET_DIR}/tmp/geosite-onesignal-ads@ads.json"
    "${SUBSET_DIR}/tmp/geosite-wteam-ads.json"
    "${SUBSET_DIR}/tmp/geosite-wteam-ads@ads.json"
    "https://raw.githubusercontent.com/lyc8503/sing-box-rules/rule-set-geoip/geoip-tor.json"
  ...
  network_cn_urls=(
    ...
    "${SUBSET_DIR}/fix/geosite-direct-added.json"
    "${SUBSET_DIR}/fix/geosite-node.json"
    "${SUBSET_DIR}/fix/geosite-ntp.json"
    "${SUBSET_DIR}/fix/geoip-direct-added.json"
    "${SUBSET_DIR}/fix/geoip-node.json"
    "${SUBSET_DIR}/fix/geoip-ntp.json"
  ...
  private_urls=(
    ...
    "${SUBSET_DIR}/fix/geosite-private-added.json"
    "${SUBSET_DIR}/fix/geoip-private-added.json"
